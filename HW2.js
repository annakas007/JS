...
if (mult_int > comp_item){
    console.log('Переменная mult_int больше ', comp_item)
}

//  21. Создать переменную div_int в которй разделить int_item на 2
let div_int = int_item / 2
...
if(item_1 < comp_item){
    console.log('Переменная item_1 больше или равна', comp_item)
}
else(console.log('Переменная item_1 меньше', comp_item))
...
if(item_2){
    console.log('Переменная item_2 =', item_2)
}
else(console.log('Переменная item_2 =', item_3))
...
if(item_3){
    console.log('Переменная item_3 =', item_2)
}
else(console.log('Переменная item_3 =', item_3))
...
if(item_5){
    console.log('Переменная item_5 =', item_5)
}
else(console.log('Переменная item_5 =', item_4))
...
if(item_4){
    console.log('Переменная item_4 =', item_5)
}
else{console.log('Переменная item_4 =', item_4)}

//  29. Создать переменную currency_convertor со значением item_2
let currency_convertor = item_2
...
if(currency_convertor) {
    let currency_usd = usd_item
    let target_currency = rub_item
    let target_currency_amount = 50
    let currency_result = 0

    if(target_currency == 'eur') {
        currency_result = target_currency_amount * usd_eur_rate
        console.log(target_currency_amount, eur_item, '=', currency_result, usd_item)
    }
    else if(target_currency == 'uah'){
        currency_result = target_currency_amount * usd_uah_rate
        console.log(target_currency_amount, eur_item, '=', currency_result, uah_item)
    }
    else if(target_currency == 'chf'){
        currency_result = target_currency_amount * usd_chf_rate
        console.log(target_currency_amount, eur_item, '=', currency_result, chf_item)
    }
    else if(target_currency == 'rub'){
        currency_result = target_currency_amount * usd_rub_rate
        console.log(target_currency_amount, eur_item, '=', currency_result, rub_item)
    } 
    else if(target_currency == 'byn'){
        currency_result = target_currency_amount * usd_byn_rate
        console.log(target_currency_amount, eur_item, '=', currency_result, byn_item)
    } 
}
